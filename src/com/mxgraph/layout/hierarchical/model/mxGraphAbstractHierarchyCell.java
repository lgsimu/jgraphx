...
public abstract class mxGraphAbstractHierarchyCell
{
   ...
   *
   * @param layer the layer relating to a specific entry into x[]
   * @param value the x value for that layer
   */
   ...
   *
   * @param layer the layer relating to a specific entry into y[]
   * @param value the y value for that layer
   */
